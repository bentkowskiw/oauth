...
func (h *Handler) AddRoutes() {
	...
	router.Post("/deauthorize", http.HandlerFunc(h.deauthorize), prefix, h.oa.ProviderName())
	router.Get("/deauthorize", http.HandlerFunc(h.deauthorize), prefix, h.oa.ProviderName())
